...
@CapacitorPlugin(name = "KugouLogin")
public class KugouLoginPlugin extends Plugin {

    private static final String T = "KugouLoginPlugin";
    ...
    public void openLogin(PluginCall call) {
        ...
        Intent intent = new Intent(getActivity(), KugouLoginWebViewActivity.class);
